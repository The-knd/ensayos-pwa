...
export class CompanyActiveAndBranding1700000006000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `UPDATE companies SET name = 'Impulsa Ferretero', primary_color = '#E2602B', logo_url = NULL WHERE id = '11111111-1111-1111-8111-111111111111';`,
    );
    await queryRunner.query(
      `UPDATE companies SET logo_url = NULL WHERE id IN ('22222222-2222-2222-8222-222222222222', '33333333-3333-3333-8333-333333333333');`,
    );
    await queryRunner.query(
